...
const { registerUser, loginUser, logOutUser, forgotPassword, resetPassword, getUserDetails, updatePassword, updateUserProfile, getAllUsers, getOneUser } = require('../controllers/userController/userController');
